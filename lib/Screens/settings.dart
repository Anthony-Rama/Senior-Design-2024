                    ...
                    return AlertDialog(
                     //title : const Text('Change Email'),
                      content: Column(
                        ...
                        children: [
                          Text('To change your email, logout and click "Reset Email here!"',
                    ...
                    return AlertDialog(
                     //title : const Text('Change Email'),
                      content: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Text('To change your password, logout and click "Forgot password?"',
                          style: TextStyle(fontSize: 16),
                          ), 
                        ],
                      ),
    ...
    try {
      ...
      switch (title) {
        case 'Change Username':
          QuerySnapshot usernameSnapshot = await users.where('username', isEqualTo: newInfo).get();
      ...
      switch (title) {
        ...
        case 'Change email':
          try {
            ...
            await user.updateEmail(newInfo);
            await user.sendEmailVerification();
            return 'A verification email has been sent to your new email address.';
